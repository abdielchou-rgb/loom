...
class ProvenanceLedger:
    ...
    def to_c2pa(self, ir: NarrativeIR) -> dict:
        ...
        （C2PA 2.x / CAWG Content Credentials）。Keel 只生产 manifest，
        **不签名** —— 签名需要 C2PA 凭证（X.509 证书），超出零依赖范围
            ...
            actions.append(
                {
                    "action": action,
                    "part": f"scene:{s.id}",
                    "softwareAgent": {"name": "Keel", "version": lw},
                }
            )
        ...
        return {
                ...
                "assertions": [
                    ...
                    },
                    {
                        ...
                        "data": {
                            ...
                            "tools": [{"name": "Keel", "version": lw}],
                        },
                    },
                    {
                        "label": "keel.participation",
            ...
            "note": (
                ...
                "签名需要 C2PA 凭证（X.509 证书），超出 Keel 零依赖范围"
