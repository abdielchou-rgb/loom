...
* **不替作者做决定。** 闸门给出理由与放行开关，决定由作者下 ——
  Loom 的立场是「AI 帮你写」，不是「AI 替你写」，也不是「AI 管着你」。
"""
...
def blocked_reason(medium: Medium) -> str | None:
    ...
    return (
        ...
        "Loom 在网文场景下提供的是**结构 + 伏笔表 + 人设卡 + 合规自检**，"
        "不是代笔。详见 loom/policy.py 的说明。"
    )
