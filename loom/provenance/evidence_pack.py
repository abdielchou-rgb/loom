...
指纹复用 `loom/render/export.py::work_fingerprint` 的**同一套**规范 JSON + SHA-256
...
def build_evidence_pack(
    ...
    manifest = {
        ...
        "replay": (
            "re-run `from loom.validators.base import run_all; "
